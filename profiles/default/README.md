...
pwsh .bot/go.ps1      # Opens first available http://localhost:<port> starting at 8686
```
...
Opens the web UI at the first available `http://localhost:<port>` starting at `8686` where you can:
