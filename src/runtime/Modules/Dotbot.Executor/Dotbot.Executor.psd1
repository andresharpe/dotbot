@{
    ...
    Description       = 'Plugin executor dispatcher. Discovers executor folders, validates metadata, and routes task execution by task.type. Each executor declares its contract via metadata.yaml and exports an Invoke-Executor function in script.ps1.'
