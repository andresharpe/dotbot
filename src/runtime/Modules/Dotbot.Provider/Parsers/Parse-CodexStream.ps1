...
Provides Process-StreamLine function for the Dotbot.Provider stream dispatcher.
Dot-sourced from Invoke-ProviderStream, so helpers (Write-ActivityLog,
Write-ClaudeLog, Get-PreviewText) are in scope via the parent module.
#>
