...
Import-Module (Join-Path $ScriptDir "src" "runtime" "Modules" "Dotbot.Core" "Dotbot.Core.psm1") -Force -DisableNameChecking
...
$dotBotThemePath = Join-Path $ScriptDir "src/runtime/Modules/Dotbot.Theme/Dotbot.Theme.psm1"
